class AppConfig:
    ...
    def __str__(self):
        return f"environment: {self.environment}, currency: {self.currency}, debug: {self.debug}"
...
if __name__ == "__main__":
    ...
    assert configs.environment == "dev"
    assert configs3.environment == "dev"
    ...
    print(f"Teste 3: Os valores alterados não são restaurados quando a configuração é obtida novamente: {configs3.environment == 'dev'}")
